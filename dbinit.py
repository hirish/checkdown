...
db.session.add(Debt(henry, barn, 1500, 'Sushi bill', False, datetime.datetime(2014,5,19)))
db.session.add(Debt(henry, barn, 2600, 'Bloodhound', False, datetime.datetime(2014,5,30)))
db.session.add(Debt(barn, henry, 0260, 'Bloodhound', False, datetime.datetime(2014,6,11)))
db.session.add(Debt(henry, barn, 1700, 'Gas & Electric', True, datetime.datetime(2014,6,21)))
db.session.add(Debt(barn, henry, 3251, 'Comcast', False, datetime.datetime(2014,6,23)))

db.session.add(Debt(fred, henry, 2600, 'Bloodhound', False, datetime.datetime(2014,6,15)))
db.session.add(Debt(fred, barn, 2600, 'Bloodhound', False, datetime.datetime(2014,6,19)))
